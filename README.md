...
![4](http://latex.codecogs.com/svg.latex?p_{target})=0.05, ![3](http://latex.codecogs.com/svg.latex?\begin{equation}score_{wake-up}=p_{target}*Miss+(1-p_{target})*FA\end{equation})

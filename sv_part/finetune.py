...
LossFunction = importlib.import_module('loss.'+args.trainfunc).__getattribute__('LossFunction')
s.__L__ = LossFunction(nClasses = args.nClasses_ft ,nOut = args.nOut ,margin=args.margin, scale=args.scale).cuda();

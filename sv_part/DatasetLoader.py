...
class kwstrial_loader(Dataset):
    def __init__(self, utt2wav, trial_file, max_frames, train_path):
        ...
        ### Read Training Files...
        with open(trial_file) as dataset_file:
            lines = dataset_file.readlines()
        ...
        for lidx, line in enumerate(lines):
            data = line.strip().split()
            #data shape : uttid1 uttid2 uttid3 uttid4(test_utt) target
